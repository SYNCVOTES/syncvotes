...
<p>
	A <strong>rule</strong> says what it takes for a proposal to pass. Every proposal carries its rule
	from the moment it is made, and the ledger applies it when it counts. All figures are in
	<strong>units</strong> of the vote: one per member in a DAO by membership, the member's holding in a
	DAO by shares.
</p>
...
<table>
	...
	<tbody>
		<tr>
			<td>
				<strong>Changes to the DAO</strong>: members and shares, name, description and picture,
				voting rules, visibility, dissolution
			</td>
			<td>The DAO's voting rules</td>
			<td>The creator at creation, then the members by a Voting rules proposal</td>
		</tr>
		<tr>
			<td><strong>Decisions and choices</strong></td>
...
<table>
	...
	<tbody>
		<tr>
			<td>Basis</td>
			<td>Whole vote, Votes cast</td>
			<td>What yes is measured against.</td>
		</tr>
		<tr>
			<td>Threshold</td>
			<td>More than half, Fraction, Percentage</td>
...
<p>
	The <strong>whole vote</strong> is every unit that existed when the proposal was made. Measured against
	it, a member who does not vote, or abstains, counts the same as a no.
</p>
<p>
	<strong>Votes cast</strong> counts only yes and no. Members who stay away or abstain do not count either
	way, so a small turnout can decide. Pair this basis with a quorum.
</p>
<p>
...
<ul>
	<li>
		<strong>More than half</strong> means strictly over 50%. Of 100 units, 51 passes and 50 does not.
		Of 5 members, 3 pass.
	</li>
	<li>
		<strong>Fraction</strong> means at least that fraction, rounded up. Two thirds of 5 members is 4 (3.33
		rounded up); two thirds of 3 members is 2.
	</li>
	<li>
		<strong>Percentage</strong> means at least that percentage, rounded up. 67% of 3 members is 3, since
		2 is only 66.7%.
	</li>
</ul>
<p>
...
<p>
	Example: under <strong>Majority of votes cast</strong> (quorum 25%) in a DAO of 100 units, 15
	units vote yes and 5 vote no. That is 75% yes, but only 20% of the vote took part, so the proposal
	fails. The tally says <code>quorum not met: 20% of the vote took part, 25% needed</code>.
</p>
...
<p>Example: a DAO of 5 members under <strong>Two thirds of the vote</strong> (4 yes needed).</p>
<ul>
...
<p>
	...
	<strong>votes cast</strong>, an early result needs yes to be sure even if every member still to
	vote says no, so most such proposals are decided at the deadline.
</p>
...
<p>
	...
	preset to <strong>Custom</strong>.
</p>
<table>
	<thead
	...
	<tbody>
		<tr
			><td>Majority of the vote</td><td>Whole vote</td><td>More than half</td><td>None</td><td
				>3 yes</td
			></tr
		>
		<tr
			><td>Majority of votes cast</td><td>Votes cast</td><td>More than half</td><td>25%</td><td
				>More yes than no, with at least 2 taking part</td
			></tr
		>
		<tr
			><td>Two thirds of the vote</td><td>Whole vote</td><td>2/3</td><td>None</td><td>4 yes</td></tr
		>
		<tr><td>Unanimous</td><td>Whole vote</td><td>100%</td><td>None</td><td>5 yes</td></tr>
	</tbody>
</table>
...
<p>
	A <strong>Voting rules</strong> proposal carries the new ballot and rule. It passes under the rules
	in force, not the ones it proposes. Once executed, the new rules apply to every change to the DAO proposed
	after that. Proposals already open keep the rule they opened with.
</p>
