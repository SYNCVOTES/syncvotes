...
<ul>
	<li>
		<strong>The app sees every ballot.</strong> It counts them, so it has to. The app's operator can read
		who voted how.
	</li>
	<li>
		<strong>The app's validator stores every ballot</strong>, as it stores every contract of every
		DAO it hosts.
	</li>
	<li>
